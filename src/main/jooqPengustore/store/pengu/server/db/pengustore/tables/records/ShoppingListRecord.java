...
public class ShoppingListRecord extends UpdatableRecordImpl<ShoppingListRecord> implements Record5<ULong, String, Double, Double, String> {
    ...
    @Override
    public ShoppingListRecord value5(String value) {
        setColor(value);
        return this;
    }

    @Override
    public ShoppingListRecord values(ULong value1, String value2, Double value3, Double value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ShoppingListRecord(ULong id, String name, Double latitude, Double longitude, String color) {
        super(ShoppingList.SHOPPING_LIST);
