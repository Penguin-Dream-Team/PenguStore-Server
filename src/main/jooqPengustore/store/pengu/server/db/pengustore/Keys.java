...
public class Keys {
    ...
    public static final UniqueKey<SmartSortingRecord> KEY_SMART_SORTING_PRIMARY = Internal.createUniqueKey(SmartSorting.SMART_SORTING, DSL.name("KEY_smart_sorting_PRIMARY"), new TableField[] { SmartSorting.SMART_SORTING.SHOPPING_LIST_ID, SmartSorting.SMART_SORTING.ROW_NUMBER, SmartSorting.SMART_SORTING.COL_NUMBER }, true);
    public static final UniqueKey<SuggestionsRecord> KEY_SUGGESTIONS_PRIMARY = Internal.createUniqueKey(Suggestions.SUGGESTIONS, DSL.name("KEY_suggestions_PRIMARY"), new TableField[] { Suggestions.SUGGESTIONS.SHOPPING_LIST_ID, Suggestions.SUGGESTIONS.ROW_NUMBER, Suggestions.SUGGESTIONS.COL_NUMBER }, true);
    ...
    public static final ForeignKey<SmartSortingRecord, ShoppingListRecord> SMART_SORTING_IBFK_1 = Internal.createForeignKey(SmartSorting.SMART_SORTING, DSL.name("smart_sorting_ibfk_1"), new TableField[] { SmartSorting.SMART_SORTING.SHOPPING_LIST_ID }, Keys.KEY_SHOPPING_LIST_PRIMARY, new TableField[] { ShoppingList.SHOPPING_LIST.ID }, true);
    public static final ForeignKey<SmartSortingRecord, ProductsRecord> SMART_SORTING_IBFK_2 = Internal.createForeignKey(SmartSorting.SMART_SORTING, DSL.name("smart_sorting_ibfk_2"), new TableField[] { SmartSorting.SMART_SORTING.ROW_NUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
    public static final ForeignKey<SmartSortingRecord, ProductsRecord> SMART_SORTING_IBFK_3 = Internal.createForeignKey(SmartSorting.SMART_SORTING, DSL.name("smart_sorting_ibfk_3"), new TableField[] { SmartSorting.SMART_SORTING.COL_NUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
    public static final ForeignKey<SuggestionsRecord, ShoppingListRecord> SUGGESTIONS_IBFK_1 = Internal.createForeignKey(Suggestions.SUGGESTIONS, DSL.name("suggestions_ibfk_1"), new TableField[] { Suggestions.SUGGESTIONS.SHOPPING_LIST_ID }, Keys.KEY_SHOPPING_LIST_PRIMARY, new TableField[] { ShoppingList.SHOPPING_LIST.ID }, true);
    public static final ForeignKey<SuggestionsRecord, ProductsRecord> SUGGESTIONS_IBFK_2 = Internal.createForeignKey(Suggestions.SUGGESTIONS, DSL.name("suggestions_ibfk_2"), new TableField[] { Suggestions.SUGGESTIONS.ROW_NUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
    public static final ForeignKey<SuggestionsRecord, ProductsRecord> SUGGESTIONS_IBFK_3 = Internal.createForeignKey(Suggestions.SUGGESTIONS, DSL.name("suggestions_ibfk_3"), new TableField[] { Suggestions.SUGGESTIONS.COL_NUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
}
