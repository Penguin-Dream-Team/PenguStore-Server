...
public class Keys {
    ...
    public static final UniqueKey<SmartSortingRecord> KEY_SMART_SORTING_PRIMARY = Internal.createUniqueKey(SmartSorting.SMART_SORTING, DSL.name("KEY_smart_sorting_PRIMARY"), new TableField[] { SmartSorting.SMART_SORTING.SHOPPING_LIST_ID, SmartSorting.SMART_SORTING.RNUMBER, SmartSorting.SMART_SORTING.CNUMBER }, true);
    public static final UniqueKey<SuggestionsRecord> KEY_SUGGESTIONS_PRIMARY = Internal.createUniqueKey(Suggestions.SUGGESTIONS, DSL.name("KEY_suggestions_PRIMARY"), new TableField[] { Suggestions.SUGGESTIONS.USER_ID, Suggestions.SUGGESTIONS.RNUMBER, Suggestions.SUGGESTIONS.CNUMBER }, true);
    ...
    public static final ForeignKey<SmartSortingRecord, ProductsRecord> SMART_SORTING_IBFK_2 = Internal.createForeignKey(SmartSorting.SMART_SORTING, DSL.name("smart_sorting_ibfk_2"), new TableField[] { SmartSorting.SMART_SORTING.RNUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
    public static final ForeignKey<SmartSortingRecord, ProductsRecord> SMART_SORTING_IBFK_3 = Internal.createForeignKey(SmartSorting.SMART_SORTING, DSL.name("smart_sorting_ibfk_3"), new TableField[] { SmartSorting.SMART_SORTING.CNUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
    ...
    public static final ForeignKey<SuggestionsRecord, ProductsRecord> SUGGESTIONS_IBFK_2 = Internal.createForeignKey(Suggestions.SUGGESTIONS, DSL.name("suggestions_ibfk_2"), new TableField[] { Suggestions.SUGGESTIONS.RNUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
    public static final ForeignKey<SuggestionsRecord, ProductsRecord> SUGGESTIONS_IBFK_3 = Internal.createForeignKey(Suggestions.SUGGESTIONS, DSL.name("suggestions_ibfk_3"), new TableField[] { Suggestions.SUGGESTIONS.CNUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
}
