...
public class Keys {
    ...
    public static final UniqueKey<RatingsRecord> KEY_RATINGS_PRIMARY = Internal.createUniqueKey(Ratings.RATINGS, DSL.name("KEY_ratings_PRIMARY"), new TableField[] { Ratings.RATINGS.ID }, true);
