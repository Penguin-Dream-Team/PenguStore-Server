...
public class Keys {
    ...
    public static final ForeignKey<SmartSortingRecord, ProductsRecord> SMART_SORTING_IBFK_1 = Internal.createForeignKey(SmartSorting.SMART_SORTING, DSL.name("smart_sorting_ibfk_1"), new TableField[] { SmartSorting.SMART_SORTING.ROW_NUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
    public static final ForeignKey<SmartSortingRecord, ProductsRecord> SMART_SORTING_IBFK_2 = Internal.createForeignKey(SmartSorting.SMART_SORTING, DSL.name("smart_sorting_ibfk_2"), new TableField[] { SmartSorting.SMART_SORTING.COL_NUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
    public static final ForeignKey<SuggestionsRecord, ProductsRecord> SUGGESTIONS_IBFK_1 = Internal.createForeignKey(Suggestions.SUGGESTIONS, DSL.name("suggestions_ibfk_1"), new TableField[] { Suggestions.SUGGESTIONS.ROW_NUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
    public static final ForeignKey<SuggestionsRecord, ProductsRecord> SUGGESTIONS_IBFK_2 = Internal.createForeignKey(Suggestions.SUGGESTIONS, DSL.name("suggestions_ibfk_2"), new TableField[] { Suggestions.SUGGESTIONS.COL_NUMBER }, Keys.KEY_PRODUCTS_BARCODE, new TableField[] { Products.PRODUCTS.BARCODE }, true);
}
